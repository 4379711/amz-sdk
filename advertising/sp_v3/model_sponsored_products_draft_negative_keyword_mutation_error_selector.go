...
// checks if the SponsoredProductsDraftNegativeKeywordMutationErrorSelector type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SponsoredProductsDraftNegativeKeywordMutationErrorSelector{}

// SponsoredProductsDraftNegativeKeywordMutationErrorSelector struct for SponsoredProductsDraftNegativeKeywordMutationErrorSelector
...
// NewSponsoredProductsDraftNegativeKeywordMutationErrorSelector instantiates a new SponsoredProductsDraftNegativeKeywordMutationErrorSelector object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewSponsoredProductsDraftNegativeKeywordMutationErrorSelector() *SponsoredProductsDraftNegativeKeywordMutationErrorSelector {
	this := SponsoredProductsDraftNegativeKeywordMutationErrorSelector{}
	return &this
}

// NewSponsoredProductsDraftNegativeKeywordMutationErrorSelectorWithDefaults instantiates a new SponsoredProductsDraftNegativeKeywordMutationErrorSelector object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewSponsoredProductsDraftNegativeKeywordMutationErrorSelectorWithDefaults() *SponsoredProductsDraftNegativeKeywordMutationErrorSelector {
	this := SponsoredProductsDraftNegativeKeywordMutationErrorSelector{}
	return &this
}

// GetEntityNotFoundError returns the EntityNotFoundError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetEntityNotFoundError() SponsoredProductsEntityNotFoundError {
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetEntityNotFoundErrorOk() (*SponsoredProductsEntityNotFoundError, bool) {
	if o == nil || IsNil(o.EntityNotFoundError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) HasEntityNotFoundError() bool {
	if o != nil && !IsNil(o.EntityNotFoundError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) SetEntityNotFoundError(v SponsoredProductsEntityNotFoundError) {
	o.EntityNotFoundError = &v
}

// GetEntityStateError returns the EntityStateError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetEntityStateError() SponsoredProductsEntityStateError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetEntityStateErrorOk() (*SponsoredProductsEntityStateError, bool) {
	if o == nil || IsNil(o.EntityStateError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) HasEntityStateError() bool {
	if o != nil && !IsNil(o.EntityStateError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) SetEntityStateError(v SponsoredProductsEntityStateError) {
	o.EntityStateError = &v
}

// GetMissingValueError returns the MissingValueError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetMissingValueError() SponsoredProductsMissingValueError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetMissingValueErrorOk() (*SponsoredProductsMissingValueError, bool) {
	if o == nil || IsNil(o.MissingValueError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) HasMissingValueError() bool {
	if o != nil && !IsNil(o.MissingValueError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) SetMissingValueError(v SponsoredProductsMissingValueError) {
	o.MissingValueError = &v
}

// GetMalformedValueError returns the MalformedValueError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetMalformedValueError() SponsoredProductsMalformedValueError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetMalformedValueErrorOk() (*SponsoredProductsMalformedValueError, bool) {
	if o == nil || IsNil(o.MalformedValueError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) HasMalformedValueError() bool {
	if o != nil && !IsNil(o.MalformedValueError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) SetMalformedValueError(v SponsoredProductsMalformedValueError) {
	o.MalformedValueError = &v
}

// GetDuplicateValueError returns the DuplicateValueError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetDuplicateValueError() SponsoredProductsDuplicateValueError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetDuplicateValueErrorOk() (*SponsoredProductsDuplicateValueError, bool) {
	if o == nil || IsNil(o.DuplicateValueError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) HasDuplicateValueError() bool {
	if o != nil && !IsNil(o.DuplicateValueError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) SetDuplicateValueError(v SponsoredProductsDuplicateValueError) {
	o.DuplicateValueError = &v
}

// GetBillingError returns the BillingError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetBillingError() SponsoredProductsBillingError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetBillingErrorOk() (*SponsoredProductsBillingError, bool) {
	if o == nil || IsNil(o.BillingError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) HasBillingError() bool {
	if o != nil && !IsNil(o.BillingError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) SetBillingError(v SponsoredProductsBillingError) {
	o.BillingError = &v
}

// GetEntityQuotaError returns the EntityQuotaError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetEntityQuotaError() SponsoredProductsEntityQuotaError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetEntityQuotaErrorOk() (*SponsoredProductsEntityQuotaError, bool) {
	if o == nil || IsNil(o.EntityQuotaError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) HasEntityQuotaError() bool {
	if o != nil && !IsNil(o.EntityQuotaError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) SetEntityQuotaError(v SponsoredProductsEntityQuotaError) {
	o.EntityQuotaError = &v
}

// GetInternalServerError returns the InternalServerError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetInternalServerError() SponsoredProductsInternalServerError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetInternalServerErrorOk() (*SponsoredProductsInternalServerError, bool) {
	if o == nil || IsNil(o.InternalServerError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) HasInternalServerError() bool {
	if o != nil && !IsNil(o.InternalServerError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) SetInternalServerError(v SponsoredProductsInternalServerError) {
	o.InternalServerError = &v
}

// GetRangeError returns the RangeError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetRangeError() SponsoredProductsRangeError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetRangeErrorOk() (*SponsoredProductsRangeError, bool) {
	if o == nil || IsNil(o.RangeError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) HasRangeError() bool {
	if o != nil && !IsNil(o.RangeError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) SetRangeError(v SponsoredProductsRangeError) {
	o.RangeError = &v
}

// GetOtherError returns the OtherError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetOtherError() SponsoredProductsOtherError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetOtherErrorOk() (*SponsoredProductsOtherError, bool) {
	if o == nil || IsNil(o.OtherError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) HasOtherError() bool {
	if o != nil && !IsNil(o.OtherError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) SetOtherError(v SponsoredProductsOtherError) {
	o.OtherError = &v
}

// GetThrottledError returns the ThrottledError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetThrottledError() SponsoredProductsThrottledError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) GetThrottledErrorOk() (*SponsoredProductsThrottledError, bool) {
	if o == nil || IsNil(o.ThrottledError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) HasThrottledError() bool {
	if o != nil && !IsNil(o.ThrottledError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) SetThrottledError(v SponsoredProductsThrottledError) {
	o.ThrottledError = &v
}

func (o SponsoredProductsDraftNegativeKeywordMutationErrorSelector) ToMap() (map[string]interface{}, error) {
...
type NullableSponsoredProductsDraftNegativeKeywordMutationErrorSelector struct {
	value *SponsoredProductsDraftNegativeKeywordMutationErrorSelector
	isSet bool
}

func (v NullableSponsoredProductsDraftNegativeKeywordMutationErrorSelector) Get() *SponsoredProductsDraftNegativeKeywordMutationErrorSelector {
	return v.value
}

func (v *NullableSponsoredProductsDraftNegativeKeywordMutationErrorSelector) Set(val *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) {
	v.value = val
	v.isSet = true
}

func (v NullableSponsoredProductsDraftNegativeKeywordMutationErrorSelector) IsSet() bool {
	return v.isSet
}

func (v *NullableSponsoredProductsDraftNegativeKeywordMutationErrorSelector) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSponsoredProductsDraftNegativeKeywordMutationErrorSelector(val *SponsoredProductsDraftNegativeKeywordMutationErrorSelector) *NullableSponsoredProductsDraftNegativeKeywordMutationErrorSelector {
	return &NullableSponsoredProductsDraftNegativeKeywordMutationErrorSelector{value: val, isSet: true}
}

func (v NullableSponsoredProductsDraftNegativeKeywordMutationErrorSelector) MarshalJSON() ([]byte, error) {
	return sonic.Marshal(v.value)
}

func (v *NullableSponsoredProductsDraftNegativeKeywordMutationErrorSelector) UnmarshalJSON(src []byte) error {
	v.isSet = true
