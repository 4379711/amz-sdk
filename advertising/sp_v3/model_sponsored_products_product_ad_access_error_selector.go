...
// checks if the SponsoredProductsProductAdAccessErrorSelector type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SponsoredProductsProductAdAccessErrorSelector{}

// SponsoredProductsProductAdAccessErrorSelector struct for SponsoredProductsProductAdAccessErrorSelector
...
// NewSponsoredProductsProductAdAccessErrorSelector instantiates a new SponsoredProductsProductAdAccessErrorSelector object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewSponsoredProductsProductAdAccessErrorSelector() *SponsoredProductsProductAdAccessErrorSelector {
	this := SponsoredProductsProductAdAccessErrorSelector{}
	return &this
}

// NewSponsoredProductsProductAdAccessErrorSelectorWithDefaults instantiates a new SponsoredProductsProductAdAccessErrorSelector object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewSponsoredProductsProductAdAccessErrorSelectorWithDefaults() *SponsoredProductsProductAdAccessErrorSelector {
	this := SponsoredProductsProductAdAccessErrorSelector{}
	return &this
}

// GetEntityNotFoundError returns the EntityNotFoundError field value if set, zero value otherwise.
func (o *SponsoredProductsProductAdAccessErrorSelector) GetEntityNotFoundError() SponsoredProductsEntityNotFoundError {
...
func (o *SponsoredProductsProductAdAccessErrorSelector) GetEntityNotFoundErrorOk() (*SponsoredProductsEntityNotFoundError, bool) {
	if o == nil || IsNil(o.EntityNotFoundError) {
		return nil, false
	}
...
func (o *SponsoredProductsProductAdAccessErrorSelector) HasEntityNotFoundError() bool {
	if o != nil && !IsNil(o.EntityNotFoundError) {
		return true
	}
...
func (o *SponsoredProductsProductAdAccessErrorSelector) SetEntityNotFoundError(v SponsoredProductsEntityNotFoundError) {
	o.EntityNotFoundError = &v
}

// GetMissingValueError returns the MissingValueError field value if set, zero value otherwise.
func (o *SponsoredProductsProductAdAccessErrorSelector) GetMissingValueError() SponsoredProductsMissingValueError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsProductAdAccessErrorSelector) GetMissingValueErrorOk() (*SponsoredProductsMissingValueError, bool) {
	if o == nil || IsNil(o.MissingValueError) {
		return nil, false
	}
...
func (o *SponsoredProductsProductAdAccessErrorSelector) HasMissingValueError() bool {
	if o != nil && !IsNil(o.MissingValueError) {
		return true
	}
...
func (o *SponsoredProductsProductAdAccessErrorSelector) SetMissingValueError(v SponsoredProductsMissingValueError) {
	o.MissingValueError = &v
}

// GetMalformedValueError returns the MalformedValueError field value if set, zero value otherwise.
func (o *SponsoredProductsProductAdAccessErrorSelector) GetMalformedValueError() SponsoredProductsMalformedValueError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsProductAdAccessErrorSelector) GetMalformedValueErrorOk() (*SponsoredProductsMalformedValueError, bool) {
	if o == nil || IsNil(o.MalformedValueError) {
		return nil, false
	}
...
func (o *SponsoredProductsProductAdAccessErrorSelector) HasMalformedValueError() bool {
	if o != nil && !IsNil(o.MalformedValueError) {
		return true
	}
...
func (o *SponsoredProductsProductAdAccessErrorSelector) SetMalformedValueError(v SponsoredProductsMalformedValueError) {
	o.MalformedValueError = &v
}

// GetInternalServerError returns the InternalServerError field value if set, zero value otherwise.
func (o *SponsoredProductsProductAdAccessErrorSelector) GetInternalServerError() SponsoredProductsInternalServerError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsProductAdAccessErrorSelector) GetInternalServerErrorOk() (*SponsoredProductsInternalServerError, bool) {
	if o == nil || IsNil(o.InternalServerError) {
		return nil, false
	}
...
func (o *SponsoredProductsProductAdAccessErrorSelector) HasInternalServerError() bool {
	if o != nil && !IsNil(o.InternalServerError) {
		return true
	}
...
func (o *SponsoredProductsProductAdAccessErrorSelector) SetInternalServerError(v SponsoredProductsInternalServerError) {
	o.InternalServerError = &v
}

// GetRangeError returns the RangeError field value if set, zero value otherwise.
func (o *SponsoredProductsProductAdAccessErrorSelector) GetRangeError() SponsoredProductsRangeError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsProductAdAccessErrorSelector) GetRangeErrorOk() (*SponsoredProductsRangeError, bool) {
	if o == nil || IsNil(o.RangeError) {
		return nil, false
	}
...
func (o *SponsoredProductsProductAdAccessErrorSelector) HasRangeError() bool {
	if o != nil && !IsNil(o.RangeError) {
		return true
	}
...
func (o *SponsoredProductsProductAdAccessErrorSelector) SetRangeError(v SponsoredProductsRangeError) {
	o.RangeError = &v
}

// GetOtherError returns the OtherError field value if set, zero value otherwise.
func (o *SponsoredProductsProductAdAccessErrorSelector) GetOtherError() SponsoredProductsOtherError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsProductAdAccessErrorSelector) GetOtherErrorOk() (*SponsoredProductsOtherError, bool) {
	if o == nil || IsNil(o.OtherError) {
		return nil, false
	}
...
func (o *SponsoredProductsProductAdAccessErrorSelector) HasOtherError() bool {
	if o != nil && !IsNil(o.OtherError) {
		return true
	}
...
func (o *SponsoredProductsProductAdAccessErrorSelector) SetOtherError(v SponsoredProductsOtherError) {
	o.OtherError = &v
}

// GetInvalidInputError returns the InvalidInputError field value if set, zero value otherwise.
func (o *SponsoredProductsProductAdAccessErrorSelector) GetInvalidInputError() SponsoredProductsInvalidInputError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsProductAdAccessErrorSelector) GetInvalidInputErrorOk() (*SponsoredProductsInvalidInputError, bool) {
	if o == nil || IsNil(o.InvalidInputError) {
		return nil, false
	}
...
func (o *SponsoredProductsProductAdAccessErrorSelector) HasInvalidInputError() bool {
	if o != nil && !IsNil(o.InvalidInputError) {
		return true
	}
...
func (o *SponsoredProductsProductAdAccessErrorSelector) SetInvalidInputError(v SponsoredProductsInvalidInputError) {
	o.InvalidInputError = &v
}

// GetThrottledError returns the ThrottledError field value if set, zero value otherwise.
func (o *SponsoredProductsProductAdAccessErrorSelector) GetThrottledError() SponsoredProductsThrottledError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsProductAdAccessErrorSelector) GetThrottledErrorOk() (*SponsoredProductsThrottledError, bool) {
	if o == nil || IsNil(o.ThrottledError) {
		return nil, false
	}
...
func (o *SponsoredProductsProductAdAccessErrorSelector) HasThrottledError() bool {
	if o != nil && !IsNil(o.ThrottledError) {
		return true
	}
...
func (o *SponsoredProductsProductAdAccessErrorSelector) SetThrottledError(v SponsoredProductsThrottledError) {
	o.ThrottledError = &v
}

func (o SponsoredProductsProductAdAccessErrorSelector) ToMap() (map[string]interface{}, error) {
...
type NullableSponsoredProductsProductAdAccessErrorSelector struct {
	value *SponsoredProductsProductAdAccessErrorSelector
	isSet bool
}

func (v NullableSponsoredProductsProductAdAccessErrorSelector) Get() *SponsoredProductsProductAdAccessErrorSelector {
	return v.value
}

func (v *NullableSponsoredProductsProductAdAccessErrorSelector) Set(val *SponsoredProductsProductAdAccessErrorSelector) {
	v.value = val
	v.isSet = true
}

func (v NullableSponsoredProductsProductAdAccessErrorSelector) IsSet() bool {
	return v.isSet
}

func (v *NullableSponsoredProductsProductAdAccessErrorSelector) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSponsoredProductsProductAdAccessErrorSelector(val *SponsoredProductsProductAdAccessErrorSelector) *NullableSponsoredProductsProductAdAccessErrorSelector {
	return &NullableSponsoredProductsProductAdAccessErrorSelector{value: val, isSet: true}
}

func (v NullableSponsoredProductsProductAdAccessErrorSelector) MarshalJSON() ([]byte, error) {
	return sonic.Marshal(v.value)
}

func (v *NullableSponsoredProductsProductAdAccessErrorSelector) UnmarshalJSON(src []byte) error {
	v.isSet = true
