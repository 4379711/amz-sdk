...
// checks if the SponsoredProductsCampaignAccessErrorSelector type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SponsoredProductsCampaignAccessErrorSelector{}

// SponsoredProductsCampaignAccessErrorSelector struct for SponsoredProductsCampaignAccessErrorSelector
...
// NewSponsoredProductsCampaignAccessErrorSelector instantiates a new SponsoredProductsCampaignAccessErrorSelector object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewSponsoredProductsCampaignAccessErrorSelector() *SponsoredProductsCampaignAccessErrorSelector {
	this := SponsoredProductsCampaignAccessErrorSelector{}
	return &this
}

// NewSponsoredProductsCampaignAccessErrorSelectorWithDefaults instantiates a new SponsoredProductsCampaignAccessErrorSelector object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewSponsoredProductsCampaignAccessErrorSelectorWithDefaults() *SponsoredProductsCampaignAccessErrorSelector {
	this := SponsoredProductsCampaignAccessErrorSelector{}
	return &this
}

// GetEntityNotFoundError returns the EntityNotFoundError field value if set, zero value otherwise.
func (o *SponsoredProductsCampaignAccessErrorSelector) GetEntityNotFoundError() SponsoredProductsEntityNotFoundError {
...
func (o *SponsoredProductsCampaignAccessErrorSelector) GetEntityNotFoundErrorOk() (*SponsoredProductsEntityNotFoundError, bool) {
	if o == nil || IsNil(o.EntityNotFoundError) {
		return nil, false
	}
...
func (o *SponsoredProductsCampaignAccessErrorSelector) HasEntityNotFoundError() bool {
	if o != nil && !IsNil(o.EntityNotFoundError) {
		return true
	}
...
func (o *SponsoredProductsCampaignAccessErrorSelector) SetEntityNotFoundError(v SponsoredProductsEntityNotFoundError) {
	o.EntityNotFoundError = &v
}

// GetMissingValueError returns the MissingValueError field value if set, zero value otherwise.
func (o *SponsoredProductsCampaignAccessErrorSelector) GetMissingValueError() SponsoredProductsMissingValueError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsCampaignAccessErrorSelector) GetMissingValueErrorOk() (*SponsoredProductsMissingValueError, bool) {
	if o == nil || IsNil(o.MissingValueError) {
		return nil, false
	}
...
func (o *SponsoredProductsCampaignAccessErrorSelector) HasMissingValueError() bool {
	if o != nil && !IsNil(o.MissingValueError) {
		return true
	}
...
func (o *SponsoredProductsCampaignAccessErrorSelector) SetMissingValueError(v SponsoredProductsMissingValueError) {
	o.MissingValueError = &v
}

// GetDateError returns the DateError field value if set, zero value otherwise.
func (o *SponsoredProductsCampaignAccessErrorSelector) GetDateError() SponsoredProductsDateError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsCampaignAccessErrorSelector) GetDateErrorOk() (*SponsoredProductsDateError, bool) {
	if o == nil || IsNil(o.DateError) {
		return nil, false
	}
...
func (o *SponsoredProductsCampaignAccessErrorSelector) HasDateError() bool {
	if o != nil && !IsNil(o.DateError) {
		return true
	}
...
func (o *SponsoredProductsCampaignAccessErrorSelector) SetDateError(v SponsoredProductsDateError) {
	o.DateError = &v
}

// GetMalformedValueError returns the MalformedValueError field value if set, zero value otherwise.
func (o *SponsoredProductsCampaignAccessErrorSelector) GetMalformedValueError() SponsoredProductsMalformedValueError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsCampaignAccessErrorSelector) GetMalformedValueErrorOk() (*SponsoredProductsMalformedValueError, bool) {
	if o == nil || IsNil(o.MalformedValueError) {
		return nil, false
	}
...
func (o *SponsoredProductsCampaignAccessErrorSelector) HasMalformedValueError() bool {
	if o != nil && !IsNil(o.MalformedValueError) {
		return true
	}
...
func (o *SponsoredProductsCampaignAccessErrorSelector) SetMalformedValueError(v SponsoredProductsMalformedValueError) {
	o.MalformedValueError = &v
}

// GetInternalServerError returns the InternalServerError field value if set, zero value otherwise.
func (o *SponsoredProductsCampaignAccessErrorSelector) GetInternalServerError() SponsoredProductsInternalServerError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsCampaignAccessErrorSelector) GetInternalServerErrorOk() (*SponsoredProductsInternalServerError, bool) {
	if o == nil || IsNil(o.InternalServerError) {
		return nil, false
	}
...
func (o *SponsoredProductsCampaignAccessErrorSelector) HasInternalServerError() bool {
	if o != nil && !IsNil(o.InternalServerError) {
		return true
	}
...
func (o *SponsoredProductsCampaignAccessErrorSelector) SetInternalServerError(v SponsoredProductsInternalServerError) {
	o.InternalServerError = &v
}

// GetRangeError returns the RangeError field value if set, zero value otherwise.
func (o *SponsoredProductsCampaignAccessErrorSelector) GetRangeError() SponsoredProductsRangeError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsCampaignAccessErrorSelector) GetRangeErrorOk() (*SponsoredProductsRangeError, bool) {
	if o == nil || IsNil(o.RangeError) {
		return nil, false
	}
...
func (o *SponsoredProductsCampaignAccessErrorSelector) HasRangeError() bool {
	if o != nil && !IsNil(o.RangeError) {
		return true
	}
...
func (o *SponsoredProductsCampaignAccessErrorSelector) SetRangeError(v SponsoredProductsRangeError) {
	o.RangeError = &v
}

// GetOtherError returns the OtherError field value if set, zero value otherwise.
func (o *SponsoredProductsCampaignAccessErrorSelector) GetOtherError() SponsoredProductsOtherError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsCampaignAccessErrorSelector) GetOtherErrorOk() (*SponsoredProductsOtherError, bool) {
	if o == nil || IsNil(o.OtherError) {
		return nil, false
	}
...
func (o *SponsoredProductsCampaignAccessErrorSelector) HasOtherError() bool {
	if o != nil && !IsNil(o.OtherError) {
		return true
	}
...
func (o *SponsoredProductsCampaignAccessErrorSelector) SetOtherError(v SponsoredProductsOtherError) {
	o.OtherError = &v
}

// GetThrottledError returns the ThrottledError field value if set, zero value otherwise.
func (o *SponsoredProductsCampaignAccessErrorSelector) GetThrottledError() SponsoredProductsThrottledError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsCampaignAccessErrorSelector) GetThrottledErrorOk() (*SponsoredProductsThrottledError, bool) {
	if o == nil || IsNil(o.ThrottledError) {
		return nil, false
	}
...
func (o *SponsoredProductsCampaignAccessErrorSelector) HasThrottledError() bool {
	if o != nil && !IsNil(o.ThrottledError) {
		return true
	}
...
func (o *SponsoredProductsCampaignAccessErrorSelector) SetThrottledError(v SponsoredProductsThrottledError) {
	o.ThrottledError = &v
}

// GetInvalidInputError returns the InvalidInputError field value if set, zero value otherwise.
func (o *SponsoredProductsCampaignAccessErrorSelector) GetInvalidInputError() SponsoredProductsInvalidInputError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsCampaignAccessErrorSelector) GetInvalidInputErrorOk() (*SponsoredProductsInvalidInputError, bool) {
	if o == nil || IsNil(o.InvalidInputError) {
		return nil, false
	}
...
func (o *SponsoredProductsCampaignAccessErrorSelector) HasInvalidInputError() bool {
	if o != nil && !IsNil(o.InvalidInputError) {
		return true
	}
...
func (o *SponsoredProductsCampaignAccessErrorSelector) SetInvalidInputError(v SponsoredProductsInvalidInputError) {
	o.InvalidInputError = &v
}

func (o SponsoredProductsCampaignAccessErrorSelector) ToMap() (map[string]interface{}, error) {
...
type NullableSponsoredProductsCampaignAccessErrorSelector struct {
	value *SponsoredProductsCampaignAccessErrorSelector
	isSet bool
}

func (v NullableSponsoredProductsCampaignAccessErrorSelector) Get() *SponsoredProductsCampaignAccessErrorSelector {
	return v.value
}

func (v *NullableSponsoredProductsCampaignAccessErrorSelector) Set(val *SponsoredProductsCampaignAccessErrorSelector) {
	v.value = val
	v.isSet = true
}

func (v NullableSponsoredProductsCampaignAccessErrorSelector) IsSet() bool {
	return v.isSet
}

func (v *NullableSponsoredProductsCampaignAccessErrorSelector) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSponsoredProductsCampaignAccessErrorSelector(val *SponsoredProductsCampaignAccessErrorSelector) *NullableSponsoredProductsCampaignAccessErrorSelector {
	return &NullableSponsoredProductsCampaignAccessErrorSelector{value: val, isSet: true}
}

func (v NullableSponsoredProductsCampaignAccessErrorSelector) MarshalJSON() ([]byte, error) {
	return sonic.Marshal(v.value)
}

func (v *NullableSponsoredProductsCampaignAccessErrorSelector) UnmarshalJSON(src []byte) error {
	v.isSet = true
