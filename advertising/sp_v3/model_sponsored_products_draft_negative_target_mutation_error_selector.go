...
// checks if the SponsoredProductsDraftNegativeTargetMutationErrorSelector type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SponsoredProductsDraftNegativeTargetMutationErrorSelector{}

// SponsoredProductsDraftNegativeTargetMutationErrorSelector struct for SponsoredProductsDraftNegativeTargetMutationErrorSelector
...
// NewSponsoredProductsDraftNegativeTargetMutationErrorSelector instantiates a new SponsoredProductsDraftNegativeTargetMutationErrorSelector object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewSponsoredProductsDraftNegativeTargetMutationErrorSelector() *SponsoredProductsDraftNegativeTargetMutationErrorSelector {
	this := SponsoredProductsDraftNegativeTargetMutationErrorSelector{}
	return &this
}

// NewSponsoredProductsDraftNegativeTargetMutationErrorSelectorWithDefaults instantiates a new SponsoredProductsDraftNegativeTargetMutationErrorSelector object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewSponsoredProductsDraftNegativeTargetMutationErrorSelectorWithDefaults() *SponsoredProductsDraftNegativeTargetMutationErrorSelector {
	this := SponsoredProductsDraftNegativeTargetMutationErrorSelector{}
	return &this
}

// GetEntityNotFoundError returns the EntityNotFoundError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetEntityNotFoundError() SponsoredProductsEntityNotFoundError {
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetEntityNotFoundErrorOk() (*SponsoredProductsEntityNotFoundError, bool) {
	if o == nil || IsNil(o.EntityNotFoundError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) HasEntityNotFoundError() bool {
	if o != nil && !IsNil(o.EntityNotFoundError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) SetEntityNotFoundError(v SponsoredProductsEntityNotFoundError) {
	o.EntityNotFoundError = &v
}

// GetEntityStateError returns the EntityStateError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetEntityStateError() SponsoredProductsEntityStateError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetEntityStateErrorOk() (*SponsoredProductsEntityStateError, bool) {
	if o == nil || IsNil(o.EntityStateError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) HasEntityStateError() bool {
	if o != nil && !IsNil(o.EntityStateError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) SetEntityStateError(v SponsoredProductsEntityStateError) {
	o.EntityStateError = &v
}

// GetMissingValueError returns the MissingValueError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetMissingValueError() SponsoredProductsMissingValueError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetMissingValueErrorOk() (*SponsoredProductsMissingValueError, bool) {
	if o == nil || IsNil(o.MissingValueError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) HasMissingValueError() bool {
	if o != nil && !IsNil(o.MissingValueError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) SetMissingValueError(v SponsoredProductsMissingValueError) {
	o.MissingValueError = &v
}

// GetMalformedValueError returns the MalformedValueError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetMalformedValueError() SponsoredProductsMalformedValueError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetMalformedValueErrorOk() (*SponsoredProductsMalformedValueError, bool) {
	if o == nil || IsNil(o.MalformedValueError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) HasMalformedValueError() bool {
	if o != nil && !IsNil(o.MalformedValueError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) SetMalformedValueError(v SponsoredProductsMalformedValueError) {
	o.MalformedValueError = &v
}

// GetDuplicateValueError returns the DuplicateValueError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetDuplicateValueError() SponsoredProductsDuplicateValueError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetDuplicateValueErrorOk() (*SponsoredProductsDuplicateValueError, bool) {
	if o == nil || IsNil(o.DuplicateValueError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) HasDuplicateValueError() bool {
	if o != nil && !IsNil(o.DuplicateValueError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) SetDuplicateValueError(v SponsoredProductsDuplicateValueError) {
	o.DuplicateValueError = &v
}

// GetBillingError returns the BillingError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetBillingError() SponsoredProductsBillingError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetBillingErrorOk() (*SponsoredProductsBillingError, bool) {
	if o == nil || IsNil(o.BillingError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) HasBillingError() bool {
	if o != nil && !IsNil(o.BillingError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) SetBillingError(v SponsoredProductsBillingError) {
	o.BillingError = &v
}

// GetEntityQuotaError returns the EntityQuotaError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetEntityQuotaError() SponsoredProductsEntityQuotaError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetEntityQuotaErrorOk() (*SponsoredProductsEntityQuotaError, bool) {
	if o == nil || IsNil(o.EntityQuotaError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) HasEntityQuotaError() bool {
	if o != nil && !IsNil(o.EntityQuotaError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) SetEntityQuotaError(v SponsoredProductsEntityQuotaError) {
	o.EntityQuotaError = &v
}

// GetInternalServerError returns the InternalServerError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetInternalServerError() SponsoredProductsInternalServerError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetInternalServerErrorOk() (*SponsoredProductsInternalServerError, bool) {
	if o == nil || IsNil(o.InternalServerError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) HasInternalServerError() bool {
	if o != nil && !IsNil(o.InternalServerError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) SetInternalServerError(v SponsoredProductsInternalServerError) {
	o.InternalServerError = &v
}

// GetRangeError returns the RangeError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetRangeError() SponsoredProductsRangeError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetRangeErrorOk() (*SponsoredProductsRangeError, bool) {
	if o == nil || IsNil(o.RangeError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) HasRangeError() bool {
	if o != nil && !IsNil(o.RangeError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) SetRangeError(v SponsoredProductsRangeError) {
	o.RangeError = &v
}

// GetOtherError returns the OtherError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetOtherError() SponsoredProductsOtherError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetOtherErrorOk() (*SponsoredProductsOtherError, bool) {
	if o == nil || IsNil(o.OtherError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) HasOtherError() bool {
	if o != nil && !IsNil(o.OtherError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) SetOtherError(v SponsoredProductsOtherError) {
	o.OtherError = &v
}

// GetThrottledError returns the ThrottledError field value if set, zero value otherwise.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetThrottledError() SponsoredProductsThrottledError {
...
// and a boolean to check if the value has been set.
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) GetThrottledErrorOk() (*SponsoredProductsThrottledError, bool) {
	if o == nil || IsNil(o.ThrottledError) {
		return nil, false
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) HasThrottledError() bool {
	if o != nil && !IsNil(o.ThrottledError) {
		return true
	}
...
func (o *SponsoredProductsDraftNegativeTargetMutationErrorSelector) SetThrottledError(v SponsoredProductsThrottledError) {
	o.ThrottledError = &v
}

func (o SponsoredProductsDraftNegativeTargetMutationErrorSelector) ToMap() (map[string]interface{}, error) {
...
type NullableSponsoredProductsDraftNegativeTargetMutationErrorSelector struct {
	value *SponsoredProductsDraftNegativeTargetMutationErrorSelector
	isSet bool
}

func (v NullableSponsoredProductsDraftNegativeTargetMutationErrorSelector) Get() *SponsoredProductsDraftNegativeTargetMutationErrorSelector {
	return v.value
}

func (v *NullableSponsoredProductsDraftNegativeTargetMutationErrorSelector) Set(val *SponsoredProductsDraftNegativeTargetMutationErrorSelector) {
	v.value = val
	v.isSet = true
}

func (v NullableSponsoredProductsDraftNegativeTargetMutationErrorSelector) IsSet() bool {
	return v.isSet
}

func (v *NullableSponsoredProductsDraftNegativeTargetMutationErrorSelector) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSponsoredProductsDraftNegativeTargetMutationErrorSelector(val *SponsoredProductsDraftNegativeTargetMutationErrorSelector) *NullableSponsoredProductsDraftNegativeTargetMutationErrorSelector {
	return &NullableSponsoredProductsDraftNegativeTargetMutationErrorSelector{value: val, isSet: true}
}

func (v NullableSponsoredProductsDraftNegativeTargetMutationErrorSelector) MarshalJSON() ([]byte, error) {
	return sonic.Marshal(v.value)
}

func (v *NullableSponsoredProductsDraftNegativeTargetMutationErrorSelector) UnmarshalJSON(src []byte) error {
	v.isSet = true
