...
// List of PolicyType
const (
	POLICYTYPE_DATE_RANGE        PolicyType = "DATE_RANGE"
	POLICYTYPE_MONTHLY_RECURRING PolicyType = "MONTHLY_RECURRING"
	POLICYTYPE_NO_CAP            PolicyType = "NO_CAP"
	POLICYTYPE_OTHER             PolicyType = "OTHER"
)
