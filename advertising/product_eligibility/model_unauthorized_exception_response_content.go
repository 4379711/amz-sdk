...
func NewUnauthorizedExceptionResponseContent() *UnauthorizedExceptionResponseContent {
...
func (o *UnauthorizedExceptionResponseContent) GetCode() float32 {
...
func (o *UnauthorizedExceptionResponseContent) GetCodeOk() (*float32, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *UnauthorizedExceptionResponseContent) HasCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *UnauthorizedExceptionResponseContent) SetCode(v float32) {
	o.Code = &v
}

// GetDetails returns the Details field value if set, zero value otherwise.
func (o *UnauthorizedExceptionResponseContent) GetDetails() string {
...
// and a boolean to check if the value has been set.
func (o *UnauthorizedExceptionResponseContent) GetDetailsOk() (*string, bool) {
	if o == nil || IsNil(o.Details) {
		return nil, false
	}
...
func (o *UnauthorizedExceptionResponseContent) HasDetails() bool {
	if o != nil && !IsNil(o.Details) {
		return true
	}
...
func (o *UnauthorizedExceptionResponseContent) SetDetails(v string) {
	o.Details = &v
}
