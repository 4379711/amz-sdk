...
func (o *NotFoundExceptionResponseContent) GetCode() float32 {
...
func (o *NotFoundExceptionResponseContent) GetCodeOk() (*float32, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *NotFoundExceptionResponseContent) HasCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *NotFoundExceptionResponseContent) SetCode(v float32) {
	o.Code = &v
}

// GetDetails returns the Details field value if set, zero value otherwise.
func (o *NotFoundExceptionResponseContent) GetDetails() string {
...
// and a boolean to check if the value has been set.
func (o *NotFoundExceptionResponseContent) GetDetailsOk() (*string, bool) {
	if o == nil || IsNil(o.Details) {
		return nil, false
	}
...
func (o *NotFoundExceptionResponseContent) HasDetails() bool {
	if o != nil && !IsNil(o.Details) {
		return true
	}
...
func (o *NotFoundExceptionResponseContent) SetDetails(v string) {
	o.Details = &v
}
