...
func (o *InventorySummary) GetLastUpdatedTime() string {
...
// and a boolean to check if the value has been set.
func (o *InventorySummary) GetLastUpdatedTimeOk() (*string, bool) {
	if o == nil || IsNil(o.LastUpdatedTime) {
		return nil, false
	}
...
func (o *InventorySummary) SetLastUpdatedTime(v string) {
	o.LastUpdatedTime = &v
}
