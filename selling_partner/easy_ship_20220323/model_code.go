...
var AllowedCodeEnumValues = []Code{
	CODE_INVALID_INPUT,
	CODE_INVALID_TIME_SLOT_ID,
	CODE_SCHEDULED_PACKAGE_ALREADY_EXISTS,
	CODE_SCHEDULE_WINDOW_EXPIRED,
	CODE_RETRYABLE_AFTER_GETTING_NEW_SLOTS,
	CODE_TIME_SLOT_NOT_AVAILABLE,
	CODE_RESOURCE_NOT_FOUND,
	CODE_INVALID_ORDER_STATE,
	CODE_REGION_NOT_SUPPORTED,
	CODE_ORDER_NOT_ELIGIBLE_FOR_RESCHEDULING,
