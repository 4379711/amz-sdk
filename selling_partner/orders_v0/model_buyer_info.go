...
func (o *BuyerInfo) GetBuyerEmail() string {
...
func (o *BuyerInfo) GetBuyerEmailOk() (*string, bool) {
	if o == nil || IsNil(o.BuyerEmail) {
		return nil, false
	}
...
func (o *BuyerInfo) HasBuyerEmail() bool {
	if o != nil && !IsNil(o.BuyerEmail) {
		return true
	}
...
func (o *BuyerInfo) SetBuyerEmail(v string) {
	o.BuyerEmail = &v
}
